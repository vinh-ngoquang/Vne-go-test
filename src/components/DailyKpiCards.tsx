...
import { Eye, Users, MousePointerClick, UserCheck, CalendarDays, Clock, BarChart2, TrendingUp, TrendingDown, Minus } from 'lucide-react';
            ...
            <div className="mt-3 pt-3 border-t border-slate-100 space-y-2 text-xs">
              ...
              <div className="flex items-center justify-between">
                <span className="text-slate-600 flex items-center gap-1.5 font-medium">
                  ...
                  <span>Cùng kỳ tuần trước:</span>
                </span>
                <div className="flex items-center gap-1.5">
                  {card.lastWeekVal !== undefined && (
                    <span className="text-[11px] text-slate-400 font-mono">
                      ({formatCompactNumber(card.lastWeekVal)})
                    </span>
                  )}
              ...
              <div className="flex items-center justify-between">
                <span className="text-slate-600 flex items-center gap-1.5 font-medium">
                  ...
                  <span>So với TB toàn kỳ:</span>
                </span>
                <div className="flex items-center gap-1.5">
                  <span className="text-[11px] text-slate-400 font-mono">
                    (TB: {formatCompactNumber(card.avgVal)})
                  </span>
              ...
              <div className="flex items-center justify-between text-[11px] text-slate-500 pt-1 border-t border-slate-50">
                ...
                <span className="font-mono font-medium text-slate-600">
                  {card.prevVal !== undefined ? formatNumber(card.prevVal) : 'Chưa có dữ liệu'}
                </span>
              </div>
            </div>

            {/* Follow-up tip */}
            <div className="mt-2.5 pt-2 border-t border-slate-100/70">
